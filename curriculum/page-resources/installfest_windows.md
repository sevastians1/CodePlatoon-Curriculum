...
- The setup from here is the same as the students using a Linux machine. Complete the installfest instructions starting at [Advanced Package Tools](https://github.com/sierraplatoon/curriculum/blob/master/page-resources/installfest_ubuntu.md#advanced-package-tool)
